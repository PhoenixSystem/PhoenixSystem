...
namespace PhoenixSystem.Engine.Tests
{
    public class EntityTests
    {
        ...
        {
            var e = new Entity.Entity("Test", "test");
            e.Delete();
        ...
        {
            Assert.Throws<ArgumentException>(() => { var e = new Entity.Entity("Test", new string[1]); });
        }

        [Fact]
        public void AddComponent_Should_Increase_Component_Count()
        {
            var e = new Entity.Entity("Test", "teset");
        ...
        {
            var e = new Entity.Entity("test", "tests");
        ...
        {
            var called = false;
            var e = new Entity.Entity("name", "test");
        ...
        public void IsInChannel_Should_Validate_Entity_Channel()
        {
            ...
            var e = new Entity.Entity("test", channelName);
        ...
        {
            var e = new Entity.Entity("name", "channel");
        ...
        public void Clone_Should_Create_a_Copy()
        {
            ...
            var e = new Entity.Entity(name, channels);
